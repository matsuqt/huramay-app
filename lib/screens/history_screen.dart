  ...
  Future<void> _fetchHistory() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://10.198.13.39:5000/api/borrow/history/${currentUser!['id']}'),
      );
...
class _HistoryDetailOverlayState extends State<HistoryDetailOverlay> {
  ...
  Future<void> _fetchItemReviews() async {
    try {
      ...
      final res = await http.get(Uri.parse('http://10.198.13.39:5000/api/reviews/item/$itemId'));
  ...
  Future<void> _submitReviewToBackend() async {
    ...
    try {
      final res = await http.post(
        Uri.parse('http://10.198.13.39:5000/api/review'),
